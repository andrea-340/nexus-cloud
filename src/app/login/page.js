...
export default function Login() {
  ...
  const verifyMfaChallenge = async () => {
    ...
    try {
      ...
      setError("Codice 2FA non valido. Riprova.");
      setLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-6">
      <div className="max-w-[400px] w-full bg-white p-10 rounded-[2.5rem] shadow-xl border border-gray-100 text-center relative overflow-hidden">
            ...
            >
              ...
              <div className="space-y-6">
                <input 
                  ...
                  className="w-full p-5 rounded-2xl bg-slate-50 border border-slate-200 outline-none font-black text-center text-3xl tracking-[0.5em] focus:ring-4 ring-blue-500/10 transition-all placeholder:text-[10px] placeholder:tracking-widest"
                />
