      ...
      <div className="max-w-[1200px] mx-auto text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8 items-center">
          {plans.map((plan) => (
            <div
              key={plan.name}
              className={`p-10 rounded-[2rem] border transition-all duration-300 flex flex-col h-full ${
                plan.featured
                  ? "border-[#1a73e8] shadow-[0_20px_50px_rgba(26,115,232,0.15)] scale-105 bg-white z-10"
