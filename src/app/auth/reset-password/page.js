...
export default function ResetPassword() {
  ...
  const handleUpdatePassword = async (e) => {
    ...
    try {
      ...
      if (recoveryCode) payload.code = recoveryCode;
      if (recoveryTokens?.accessToken && recoveryTokens?.refreshToken) {
        payload.accessToken = recoveryTokens.accessToken;
        payload.refreshToken = recoveryTokens.refreshToken;
      }
      ...
      if (!res.ok) throw new Error(data?.error || "Errore durante l'aggiornamento della password.");
