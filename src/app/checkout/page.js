    ...
    <div className="min-h-screen bg-gray-50 pt-32 pb-20 px-6">
      <div className="max-w-[1000px] mx-auto">
        {step === 1 ? (
          <>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {PIANI.map((p) => (
                <div
                  key={p.id}
                  className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-xl transition-all flex flex-col items-center text-center"
                >
          ...
          <div className="max-w-[450px] mx-auto bg-white p-10 rounded-[3rem] shadow-2xl">
            <button
              onClick={() => setStep(1)}
